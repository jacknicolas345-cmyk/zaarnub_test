...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CONLPlfS.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CWCw5y9L.js").then((n2) => n2.V),
...
var ROUTER_BASEPATH = "zaarnub_test";
var SERVER_FN_BASE = "/zaarnub_test/_serverFn/";
